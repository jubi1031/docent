...
const P4 = ({ isCurrentPage }: P4Props) => {
  return (
    <Wrapper>
      <Commentary>
        <Commentary.Header>
        ...
        <Commentary.Body>
          <Body>
            <Swiper modules={[Pagination]} pagination={{ clickable: true }}>
              <SwiperSlide>
                <Paragraph>
                  <Commentary.TextDecoration>
                    <Commentary.Quote>“&nbsp;</Commentary.Quote>정신의학적
                    시선으로 해설을 더한
                  </Commentary.TextDecoration>
                  <Commentary.TextDecoration>
                    &lt;달러구트 꿈 백화점&gt; 오디오 도슨트
                  ...
                  <Commentary.TextDecoration>
                    아래 버튼을 누르시면&lt;달러구트 꿈 백화점&gt;의
                  </Commentary.TextDecoration>
                  <Commentary.TextDecoration>
                    전자책을 읽으실 수 있습니다.
                    <Commentary.Quote>&nbsp;”</Commentary.Quote>
                  </Commentary.TextDecoration>
                </Paragraph>
              </SwiperSlide>
              <SwiperSlide>
                <Paragraph>
                  <Commentary.TextDecoration>
                    <Commentary.Quote>“&nbsp;</Commentary.Quote>여러분도 책을
                    읽으며
                  </Commentary.TextDecoration>
                  <Commentary.TextDecoration>
                    다양한 상상을 펼처보길 바랍니다.
                  ...
                  <Commentary.TextDecoration>
                    감사합니다.<Commentary.Quote>&nbsp;”</Commentary.Quote>
                  </Commentary.TextDecoration>
                </Paragraph>
              </SwiperSlide>
            </Swiper>
