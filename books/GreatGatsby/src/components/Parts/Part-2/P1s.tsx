...
const P1_0 = () => {
  const { swiperRef} = useContext(ConfigContext)
  return (
    <ParagraphM>
    <Message.Background>
    <Message.BackgroundH>
...
const P1_3 = () => (
  <ParagraphM>
    ...
    <Message.Head></Message.Head>
      ...
      <Message.Box>
        <p>
        일반적인 의학용어로 ‘외상(physical trauma)’을<br/>
        뜻하지만, 심리학적으로<br/>
        '정신적 외상(psychological trauma)'을 말한다.<br/>
...
const P1_5 = () => (
  <ParagraphM>
    ...
    <Message.Head></Message.Head>
      ...
      <Message.Box>
        <p> 
        일상의 철학자 ‘알랭 드 보통’이 파헤친 ‘불안’<br/>
        그 원인과 해법, 행복한 인생을 살기 위한<br/>
        방법이 담긴 현대인을 위한 철학서
        </p> 
      </Message.Box>
      </Message.BoxC>
...
const P1_6 = () => (
  <ParagraphM>
    ...
    <Message.Head></Message.Head>
      ...
      <Message.Box>
        <p> 
        본인이 정말 하고 싶은게 무엇인가?<br/>
        10년, 20년, 30년 뒤 어떤 사람으로 있고 싶은가?<br/>
