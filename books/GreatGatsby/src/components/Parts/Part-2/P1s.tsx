...
const P1_2 = () => {
  const messages: Messages[] = [
    ...
    {
      user: 'kim',
      messages: ['저만 해도 무슨 꿈을 꿨을 때 뭔가 \n임팩트 있는 꿈을 꾸면 \n혹시 이게 뭔가 대단한\n길몽이나 흉몽이 아닐까?\n생각해서 검색을 하고 \n그렇게 되는데.',
        '그럼 꿈 해몽 같은 거는\n어떻게 나오게 된 거예요?'
      ]
    },
    {
      user: 'yang',
      messages: ['동양철학에서 사주하고\n비슷한 것 같습니다.\n그러니까 사주 같은 경우도\n우리가 몇날 몇 시에 \n태어난 사람들의 어떤 삶을 \n보니까 이러이러 하더라.\n그런 몇몇 사람들을 가지고\n통계를 만든 거잖아요.',
        '꿈이라는 것도 마찬가지로\n현재 내가 이런 일이 일어났을 때',
        "'과거에 뭘 했지?'\n내가 봤더니\n'어떤 꿈을 꿨네?'",
...
const P1_4 = () => {
  const messages: Messages[] = [
    {
      user: 'kim',
      messages: ['또 많은 이들을 울컥하게 한\n에피소드도 있는데요.\n죽음을 앞두신 분이 사랑하는\n사람들에게 꿈을 보내기 위해서\n의뢰하는 내용이 있었거든요.',
        '가까운 사람을 잃어서\n상실감이 큰 분들께\n고인을 되돌아보게 하는\n행동은 도움이 되는 걸까요?']
    },
    {
      user: 'yang',
      messages: ['실제로 도움이 많이 됩니다.\n가족 구성원 중에 한 분을 상실한 그런 경험이 있는\n나머지 가족 구성원들 같은\n경우가 대부분 고인에 대한\n얘기를 못 꺼내요. 서로.',
